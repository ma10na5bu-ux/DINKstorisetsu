...
| 記法 | WordPress出力 | 使用場面 | 厳守する上限 |
|---|---|---|---|
| `**太字**` | `<strong>太字</strong>` | 商品名・サービス名・固有名詞のみ | 記事全体で5か所以内 |
| `<mark>テキスト</mark>` | SWELLマーカー（黄） | 記事全体で「これだけ覚えて」という1文 | **記事全体で1〜2か所のみ** |
| `<mark>**テキスト**</mark>` | SWELLマーカー（黄）＋太字 | 原則使わない。どうしても必要な場合のみ | 記事全体で1か所まで |
...
**禁止パターン：**
- H2ごとにハイライトを入れる（読者が慣れてどこも目立たなくなる）
...
- 箇条書きがなくても、見出し・小見出しで意味を分割＋不要な語を削ればOK
